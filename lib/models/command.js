...
Command.prototype.checkDependencies = true;
...
Command.prototype.validateAndRun = function(args) {
  ...
  if (this.checkDependencies) {
    var EmberCliDependencyChecker = require('ember-cli-dependency-checker');
    new EmberCliDependencyChecker(this.project).checkDependencies();
  }
